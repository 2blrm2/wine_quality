...
def train_and_evaluate(config_path):
    ...
    alpha= config['estimators']['ElasticNet']['parms']['alpha']
    l1_ratio= config['estimators']['ElasticNet']['parms']['l1_ratio']
    ...
    with open(parms_file,'w') as f:
        parms={"alpha": alpha, "l1_ratio": l1_ratio,}
